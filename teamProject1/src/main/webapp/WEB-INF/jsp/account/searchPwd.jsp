...
<div id="joindiv">
  <form action="searchPwd.do" class="joinForm" method="post" onsubmit="return checkField();">
    <h2>비밀번호 찾기</h2>
	
	<div class="textForm">
      <input name="member_id" type="text" class="inputField" placeholder="아이디">
    </div>
    <div class="textForm">
